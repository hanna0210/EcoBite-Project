        ...
        <div wire:loading.remove
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                @foreach ($paymentMethods as $paymentMethod)
                    <button wire:click='initPayment({{ $paymentMethod->id }})' type="button"
                        class="flex items-center p-1 border rounded shadow-sm hover:shadow-lg hover:border-primary-500">
