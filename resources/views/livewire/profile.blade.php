                ...
                <x-tab.body tab="2">
                    ...
                    <div class="w-full lg:w-8/12">
                        <x-form action="changePassword" :noClass="true">
                            ...
                            <x-input-password title="{{ __('Current Password') }}" name="current_password" />
                            <x-input-password title="{{ __('New Password') }}" name="new_password" />
                            <x-input-password title="{{ __('Confirm New Password') }}"
