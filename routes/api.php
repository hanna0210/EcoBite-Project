...
use App\Http\Controllers\API\FoodRescueController;
use App\Http\Controllers\API\FavouriteFoodRescueController;
...
//food rescues
Route::apiResource('food-rescues', FoodRescueController::class);
Route::get('food-rescues/nearby/list', [FoodRescueController::class, 'nearby']);
Route::post('food-rescues/{id}/purchase', [FoodRescueController::class, 'purchase']);
...
Route::group(['middleware' => ['auth:sanctum', "user.active.check"]], function () {
    ...
    Route::apiResource('favourite/food-rescues', FavouriteFoodRescueController::class);
    ...
    Route::group(['middleware' => ['role:manager']], function () {
        ...
        //food rescues management for vendors
        Route::get('/my/food-rescues', [FoodRescueController::class, 'index']);
        Route::post('/my/food-rescues', [FoodRescueController::class, 'store']);
        Route::put('/my/food-rescues/{id}', [FoodRescueController::class, 'update']);
        Route::delete('/my/food-rescues/{id}', [FoodRescueController::class, 'destroy']);
