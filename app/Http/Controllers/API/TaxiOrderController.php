...
class TaxiOrderController extends Controller
{
    ...
    public function book(Request $request)
    {
        ...
        try {
            ...
            if (number_format($vehicleType->total, 2) > number_format($request->total, 2)) {
    ...
    public function current(Request $request)
    {
        ...
        $taxiBookingOrder = Order::with('driver.vehicle', 'payment_method')->otherCurrentStatus(['failed', 'cancelled', 'delivered', 'scheduled'])
            ->whereHas('taxi_order')
