...
class AppSettingsLivewire extends BaseLivewireComponent
{
    ...
    public function mount()
    {
        ...
        $this->primaryColor = setting('appColorTheme.primaryColor', '#246fd0');
        ...
        $this->onboardingIndicatorActiveDotColor = setting('appColorTheme.onboardingIndicatorActiveDotColor', '#246fd0');
