...
class SMSGatewayLivewire extends BaseLivewireComponent
{
    ...
    public function initiateEdit($id)
    {
        ...
        } else if ($this->selectedModel->slug == "arkesel") {
            $this->authkey = env("ARKESEL_AUTHKEY");
            $this->sender = env("ARKESEL_SENDER");
        }
        //edit custom code
    ...
    public function update()
    {
        ...
        try {
            ...
            if ($this->selectedModel->slug == "twilio") {
                ...
                $group = "ARKESEL";
                setEnv("ARKESEL_AUTHKEY", $this->authkey, $group);
                setEnv("ARKESEL_SENDER", $this->sender, $group);
            }
            //custom code
